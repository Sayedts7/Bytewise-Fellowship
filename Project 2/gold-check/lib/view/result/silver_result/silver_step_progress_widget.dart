...
class StepProgressWidgetForSilver extends StatelessWidget {

  final double result;
  final int steps;
  const StepProgressWidgetForSilver({Key? key, required this.result, required this.steps}) : super(key: key);
