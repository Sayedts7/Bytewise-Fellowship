...
class Screenshot_Share extends StatefulWidget {
  ...
  final String des;
  final String image;
  const Screenshot_Share({Key? key, required this.title, required this.des, required this.image}) : super(key: key);
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                      ...
                      child:widget.image == '' ? Container() : Image(image: NetworkImage(widget.image))
